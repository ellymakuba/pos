...
<head>
	...
	<title><?php echo $this->config->item('company').' -- '.$this->lang->line('common_powered_by').'webafriq' ?></title>
...
<div id="menubar">
	<div id="menubar_container">
		...
		<span style='font-size:8pt;'><?php echo $this->lang->line('common_powered_by').' webafriq'; ?></span>
	</div>
