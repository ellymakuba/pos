...
<th style="width:11%;"><?php echo $this->lang->line('recvs_bonus'); ?></th>
...
else
{
	...
	?>
		...
		<td><?php echo form_input(array('name'=>'bonus','value'=>$item['bonus'],'size'=>'3'));?></td>
...
$(document).ready(function()
{
    ...
    $("#finish_sale_button").click(function()
    {
			...
			$processSale=false;
			$amount=$('input[name=amount_tendered]').val().replace(/[^0-9]/g, '');
			if($('#supplier').val()!='')
			{
